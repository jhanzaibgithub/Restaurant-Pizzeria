...
class DeliveryManController extends Controller
{
    ...
    public function index(): Renderable
    {
        ...
        return view('admin-views.delivery-man.index', compact('branches'));
    }
    ...
    {
        $dm = $this->delivery_man->with(['reviews'])->withCount('reviews')->where(['id' => $id])->first();
    ...
    public function edit($id): Renderable
    {
        ...
        $branches = DB::table('branches')->select('id', 'name')->get();
        return view('admin-views.delivery-man.edit', compact('delivery_man', 'branches'));
    }
    ...
    {
        $dm = $this->delivery_man->where('application_status', 'approved')->select('f_name as First Name', 'l_name as Last Name', 'phone as Phone', 'identity_type', 'identity_number')->lazy();
