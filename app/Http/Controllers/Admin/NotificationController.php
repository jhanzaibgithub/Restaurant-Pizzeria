...
class NotificationController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $notification->status = $request->schedule_at ? 0 : 1;
        $notification->schedule_at = $request->schedule_at ? Carbon::createFromFormat("Y-m-d\TH:i", $request->schedule_at) : null;
        ...
        if($notification->schedule_at === null){
            try {
            ...
            Toastr::success(translate('Notification scheduled successfully!'));
        }
