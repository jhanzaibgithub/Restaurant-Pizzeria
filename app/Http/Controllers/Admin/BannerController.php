...
class BannerController extends Controller
{
    ...
    function list(Request $request): Renderable
    {
        ...
        $categories = $this->category->where(['parent_id' => 0])->orderBy('name')->get(['id', 'name']);
        ...
        return view('admin-views.banner.list', compact('banners', 'products', 'categories', 'productMap', 'categoryMap'));
    }
