...
class AttributeController extends Controller
{
    ...
    function index(Request $request): Renderable
    {
        ...
        return view('admin-views.attribute.index', compact('attributes', 'search', 'languageSettings'));
    }
    ...
    public function edit($id): Renderable
    {
        ...
        return view('admin-views.attribute.edit', compact('attribute', 'languageSettings'));
    }
    ...
    public function status(Request $request): RedirectResponse
    {
        ...
        Toastr::success(translate('Attribute status updated!'));
        return back();
    }
}
