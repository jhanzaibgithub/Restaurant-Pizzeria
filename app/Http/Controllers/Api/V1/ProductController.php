...
class ProductController extends Controller
{
    ...
    {	
        ...
        $products = ProductLogic::get_latest_products($branch, $request['limit'], $request['offset'], $request['product_type'], $request['name'], $request['category_ids']);
...
{	
    try {
        ...
        return response()->json([
            'errors' => [
                ['code' => 'product-001', 'message' => translate('no_data_found')],
            ]
        ], 404);
    }
}
