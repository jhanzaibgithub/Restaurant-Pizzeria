...
class TableController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'group_id.required' => translate('Group select is required!'),
        ]);
    ...
    public function edit($id): Renderable
    {
        ...
        $groups = $this->group->select('id', 'title')->orderBy('title')->get();
        return view('branch-views.table.edit', compact('table', 'groups'));
    }
