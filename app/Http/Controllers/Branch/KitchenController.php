...
class KitchenController extends Controller
{
    ...
    function list(Request $request): Renderable
    {
        ...
        $chefBranchNames = $chefs->getCollection()
            ->mapWithKeys(fn($chef) => [$chef->id => User::get_chef_branch_name($chef)]);

        return view('branch-views.kitchen.list', compact('chefs', 'search', 'chefBranchNames'));
    }
