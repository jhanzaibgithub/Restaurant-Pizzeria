        ...
        <div class="row" style="padding-bottom: 20px">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body" style="padding: 20px">
                        ...
                        @php($config = $paymentSettings['cash_on_delivery'] ?? null)
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body" style="padding: 20px">
                        <h5 class="text-center">Payment Method</h5>
                        @php($config = $paymentSettings['digital_payment'] ?? null)
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body" style="padding: 20px">
                        ...
                        @php($config = $paymentSettings['ssl_commerz_payment'] ?? null)
                        <form
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body" style="padding: 20px">
                        ...
                        @php($config = $paymentSettings['razor_pay'] ?? null)
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body" style="padding: 20px">
                        ...
                        @php($config = $paymentSettings['paypal'] ?? null)
            ...
            <div class="col-md-6 pt-4">
                <div class="card">
                    <div class="card-body" style="padding: 20px">
                        ...
                        @php($config = $paymentSettings['stripe'] ?? null)
