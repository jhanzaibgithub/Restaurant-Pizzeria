                            ...
                            <div class="col-sm-6">
                                <div class="text-sm-right">
                                    <div class="d-flex flex-wrap gap-2 justify-content-sm-end">
                                        ...
                                        @endif
                                        <a class="btn btn-info" href="{{route('branch.pos.invoice',[$order['id']])}}">
                        ...
                        <div class="row justify-content-md-end mb-3">
                            <div class="col-md-9 col-lg-8">
                                <dl class="row">
                                    ...
                                    <dd class="col-6 text-dark text-right">
                                        {{ \App\CentralLogics\Helpers::set_symbol($sub_total =$sub_total+$total_tax+$add_ons_cost-$total_dis_on_pro + $add_ons_tax_cost + ($order->total_tax_amount)) }}</dd>
                        ...
                        <div class="card-body text-capitalize d-flex flex-column gap-4">
                            ...
                            @if($order['order_type'] != 'pos')
                                <div class="">
                                    ...
                                    <select name="order_status" onchange="route_alert('{{route('branch.orders.status',['id'=>$order['id']])}}'+'&order_status='+ this.value,'{{translate("Change the order status to ") }}'+  this.value.replace(/_/g, ' '))" class="status custom-select">
                                        @if($order['order_type'] != 'dine_in')
...
{{--                                    <div class="d-flex justify-content-between gap-3 border-top mt-3 pt-3">--}}
                                    ...
                                    <div class="delivery--information-single flex-column">
                                        @php($address=$address ?? $order->delivery_address)
                                        {{--                                @dump($address)--}}
                                        <div class="d-flex">
