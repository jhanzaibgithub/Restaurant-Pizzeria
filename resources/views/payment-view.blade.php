        ...
        <section class="col-lg-12">
            <div class="mt-3">
                <div class="row">
                                ...
                                <div class="card-body" style="height: 70px">
                                    ...
                                    <!-- Note that the amount is in paise = 50 INR -->
                                        ...
                                        <script src="https://checkout.razorpay.com/v1/checkout.js"
                                                ...
                                                data-buttontext="Pay {{$order_amount}} {{$currencyCode}}"
                                                data-name="{{$restaurantName}}"
                                                data-description="{{$order_amount}}"
                                                data-image="{{asset('/storage/restaurant/'.$restaurantLogo)}}"
                                    ...
                                    <button class="btn btn-block click-if-alone" type="button" id="razorpay-button"
                                            ...
                                            onclick="{{$currencyCode == 'INR' ? "$('.razorpay-payment-button').click()" : "toastr.error('Your currency is not supported by Razor Pay.')"}}">
                                        <img width="100"
                    ...
                    @php($config = $paymentConfigs['paystack'] ?? null)
                    @if(isset($config) && $config['status'])
                        <?php
                            $Paystack = new App\Http\Controllers\PaystackController();
                            $reff = $Paystack::generate_transaction_Reference();
                        ?>
                        <div class="col-md-6 mb-4" style="cursor: pointer">
                            <div class="card">
                                <div class="card-body" style="height: 70px">
                    ...
                    @php($config = $paymentConfigs['senang_pay'] ?? null)
                    @if(isset($config) && $config['status'])
                        <div class="col-md-6 mb-4" style="cursor: pointer">
                            <div class="card">
                                <div class="card-body" style="height: 70px">
                                    ...
                                    <button class="btn btn-block click-if-alone" type="button" id="senangpay-button"
                                            ...
                                            onclick="{{$currencyCode == 'MYR' ? 'document.order.submit()' : "toastr.error('Your currency is not supported by Senang Pay.')"}}">
                                        <img width="100"
                    ...
                    @php($config = $paymentConfigs['bkash'] ?? null)
                    @if(isset($config) && $config['status'])
                        <div class="col-md-6 mb-4" style="cursor: pointer">
                            <div class="card">
                                <div class="card-body" style="height: 70px">
                    ...
                    @php($config = $paymentConfigs['paymob'] ?? null)
                    @if(isset($config) && $config['status'])
                        <div class="col-md-6 mb-4" style="cursor: pointer">
                            <div class="card">
                                <div class="card-body" style="height: 70px">
                    ...
                    @php($config = $paymentConfigs['mercadopago'] ?? null)
                    @if(isset($config) && $config['status'])
                        <div class="col-md-6 mb-4" style="cursor: pointer">
                            <div class="card">
                    ...
                    @php($config = $paymentConfigs['flutterwave'] ?? null)
                    @if(isset($config) && $config['status'])
                        <div class="col-md-6 mb-4" style="cursor: pointer">
                            <div class="card">
                                <div class="card-body pt-2" style="height: 70px">
                    ...
                    @php($config = $paymentConfigs['internal_point'] ?? null)
                    @if(isset($config) && $config['status'])
                        <div class="col-md-6 mb-4" style="cursor: pointer">
                            <div class="card">
                                <div class="card-body" style="height: 70px">
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <hr>
                                        @php($value = $pointPerCurrency)

                                        @php($point = $customer['point'])
                                        <span>{{ translate('Order Amount') }} : {{ $formattedOrderAmount }}</span><br>
