...
<head>
    ...
    <!-- Favicon -->
    @php($icon = $branchLayoutSettings['fav_icon'] ?? '')
    ...
    <link rel="stylesheet" href="{{asset('assets/admin')}}/css/style.css?v=1.3">

    {{-- Header-Pages CSS  --}}
    <link rel="stylesheet" href="{{asset('assets/admin')}}/css/headerPages.css">
    {{--  fontAwesome  --}}
    <link rel="stylesheet" href="{{url('fontawesome-efood')}}/css/all.min.css">
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        document.addEventListener("click", function (event) {
            ...
            if (!href || href === "#" || href.startsWith("javascript:") || href.startsWith("mailto:") || href.startsWith("tel:") || target === "_blank" || link.hasAttribute("download") || link.dataset.toggle) {
                return;
            }
    ...
    window.addEventListener("load", function () {
        setTimeout(hideBranchLoader, 100);
    });
</script>
