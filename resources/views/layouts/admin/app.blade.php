...
<head>
    ...
    @php($icon = $adminLayoutSettings['fav_icon'] ?? '')
    ...
    {{--  fontAwesome  --}}
    <link rel="stylesheet" href="{{asset('fontawesome-efood')}}/css/all.min.css">

     {{--  ------------External Summer Note--------  --}}
     <!--  summernote css/js -->
...
<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.js"></script>
    ...
    <link rel="stylesheet" href="{{asset('assets/admin/js/daterangepicker.js')}}">
