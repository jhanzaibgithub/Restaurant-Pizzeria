...
<div class="content container-fluid">
    ...
    <div class="d-flex flex-wrap gap-2 align-items-center mb-3">
        ...
        <span class="badge badge-soft-dark rounded-50 fz-14">{{count($order->details ?? [])}}</span>
    </div>
    <!-- End Page Header -->
                            ...
                            <div class="text-sm-right">
                                <div class="d-flex flex-wrap gap-2 justify-content-sm-end">
                                    ...
                                    <div class="hs-unfold ml-1">
                                        ...
                                        @php($origin=$deliveryOrigin)
                                        @php($current=$deliveryCurrent)
                                        @if(isset($origin))
                    ...
                    <table class="table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                        ...
                                        <div class="media-body text-dark fz-12">
                                            ...
                                            <div class="d-flex gap-2">
                                                ...
                                                <span>
                                                    ...
                                                    @php($addon=isset($addonMap) ? $addonMap->get($id) : null)
                                                    @php($add_on_qtys==null? $add_on_qty=1 : $add_on_qty=$add_on_qtys[$key2])

                                                    <div class="font-size-sm text-body">
                                                        <span>{{$addon ? $addon['name'] : translate('addon deleted')}} : </span>
                                                        <span class="font-weight-semibold">
                                                            {{$add_on_qty}} x {{ \App\CentralLogics\Helpers::set_symbol($add_on_prices[$key2] ?? 0) }} <br>
                                                        </span>
                                                    </div>
                                                    @php($add_ons_cost += isset($add_on_prices[$key2]) ? ($add_on_prices[$key2] * $add_on_qty) : 0)
                                                    @php($add_ons_tax_cost += isset($add_ons_tax_cost[$key2]) ? ($add_ons_tax_cost[$key2] * $add_on_qty) : 0)
                                ...
                                <td class="text-right">{{\App\CentralLogics\Helpers::set_symbol($amount-$tot_discount + $product_tax + $add_ons_cost)}}</td>
                            </tr>
                    ...
                    <div class="row justify-content-md-end mb-3">
                        <div class="col-md-9 col-lg-8">
                            <dl class="row">
                                ...
                                <dd class="col-6 text-dark text-right">
                                    {{ \App\CentralLogics\Helpers::set_symbol($sub_total =$sub_total+$total_tax+$add_ons_cost-$total_dis_on_pro + $add_ons_tax_cost + ($order->total_tax_amount)) }}
                                </dd>
                                ...
                                <!-- <dd class="col-6 border-top pt-2 fz-16 font-weight-bold text-dark text-right">{{ \App\CentralLogics\Helpers::set_symbol( $order['order_amount'] + $order['delivery_charge']) }}</dd> -->
                            </dl>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="card mb-3">
                <div class="card-body text-capitalize d-flex flex-column gap-4">
                    ...
                    @if($order['order_status'] != 'pending' && $order['order_type']!='take_away' && $order['order_type'] != 'pos' && $order['order_type'] != 'dine_in' && !$order['delivery_man_id'])
                    ...
                    <div class="media flex-wrap gap-3">
                        <div class="">
                            <img class="avatar avatar-lg rounded-circle"
                                src="{{ asset('storage/branch/' . optional($order->branch)->image) }}"
            ...
            <div class="card mb-3">
                <div class="card-body">
                    <h4 class="mb-4 d-flex gap-2">
                        <i class="tio-bookmark text-dark"></i>
                        {{translate('Order_confirmation_image')}}
                    </h4>
                    <div class="media flex-wrap gap-3">
                        <div class="edit-btn cursor-pointer" data-toggle="modal" data-target="#imageModal">
                            <img class="avatar avatar-lg rounded-circle" src="{{asset('/storage/order/'.$order['order_confirmation_image'])}}" alt="Image">
                        </div>
            ...
            <!-- Image Modal -->
            <div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="imageModalLabel" id="imageModal" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title h4" id="imageModalLabel">{{translate('Order_confirmation_image')}}</h5>
                            <button type="button" class="btn btn-xs btn-icon btn-ghost-secondary" data-dismiss="modal" aria-label="Close">
                                <i class="tio-clear tio-lg"></i>
                            </button>
                        </div>
                        <div class="modal-body">
                            <img class="img-fluid" src="{{asset('/storage/order/'.$order['order_confirmation_image'])}}" alt="Large Image">
                        </div>
                    </div>
                </div>
            </div>
