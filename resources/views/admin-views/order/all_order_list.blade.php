        ...
        @if ($status == 'all')
            <div class="px-4 mt-1">
                <div class="row g-2">
                    <div class="col-sm-6 col-lg-3">
                        <a class="order--card h-100" href="javacript:void(0)">
                            <div class="d-flex flex-column justify-content-start align-items-baseline pt-5">
                                ...
                                {{$order_count['earning']}}{{\App\CentralLogics\Helpers::currency_symbol()}}
                                </span>
                                ...
                                @if($percentageChanges['earning'] > 0)
                                <span class="badge-soft-success px-2 py-1 rounded fs-2">
                                    <i class="tio-arrow-upward"></i>{{ translate($percentageChanges['earning'] . '%') }}
                                </span>
                                @elseif($percentageChanges['earning'] < 0)
                                <span class="badge-soft-danger px-2 py-1 rounded fs-2">
                                    <i class="tio-arrow-downward"></i>{{ translate($percentageChanges['earning'] . '%') }}
                                </span>
                                @else
                                <span class="badge-soft-secondary px-2 py-1 rounded fs-2">
                                    <i class="tio-arrow-rightward"></i>{{ translate($percentageChanges['earning'] . '%') }}
                                </span>
                                @endif
                            </div>
                        </a>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <a class="order--card h-100" href="{{ route('admin.orders.all-dine-list', ['all']) }}">
                            <div class="d-flex flex-column justify-content-start align-items-baseline pt-5">
                                <span style="font-size: 25px;" class="card-title pb-3 text-107980">
                                    {{$order_count['dinein']}}
                                </span>
                                ...
                                @if($percentageChanges['dinein'] > 0)
                                <span class="badge-soft-success px-2 py-1 rounded fs-2">
                                    <i class="tio-arrow-upward"></i>{{ translate($percentageChanges['dinein'] . '%') }}
                                </span>
                                @elseif($percentageChanges['dinein'] < 0)
                                <span class="badge-soft-danger px-2 py-1 rounded fs-2">
                                    <i class="tio-arrow-downward"></i>{{ translate($percentageChanges['dinein'] . '%') }}
                                </span>
                                @else
                                <span class="badge-soft-secondary px-2 py-1 rounded fs-2">
                                    <i class="tio-arrow-rightward"></i>{{ translate($percentageChanges['dinein'] . '%') }}
                                </span>
                                @endif
                            </div>
                        </a>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <a class="order--card h-100" href="{{ route('admin.orders.all-takeaway-list', ['all']) }}">
                            <div class="d-flex flex-column justify-content-start align-items-baseline pt-5">
                                <span style="font-size: 25px;" class="card-title pb-3 text-107980">
                                    {{$order_count['takeaway']}}
                                </span>
                                <h4 style="font-size: 16px; color:#6D6D6D;"
                                    class="card-subtitle d-flex justify-content-between m-0 pb-1 align-items-center">
                                    <span>{{ translate('take away') }}</span>
                                </h4>
                                @if($percentageChanges['takeaway'] > 0)
                                <span class="badge-soft-success px-2 py-1 rounded fs-2">
                                    <i class="tio-arrow-upward"></i>{{ translate($percentageChanges['takeaway'] . '%') }}
                                </span>
                                @elseif($percentageChanges['takeaway'] < 0)
                                <span class="badge-soft-danger px-2 py-1 rounded fs-2">
                                    <i class="tio-arrow-downward"></i>{{ translate($percentageChanges['takeaway'] . '%') }}
                                </span>
                                @else
                                <span class="badge-soft-secondary px-2 py-1 rounded fs-2">
                                    <i class="tio-arrow-rightward"></i>{{ translate($percentageChanges['takeaway'] . '%') }}
                                </span>
                                @endif
                            </div>
                        </a>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <a class="order--card h-100" href="{{ route('admin.orders.all-delivery-list', ['all']) }}">
                            <div class="d-flex flex-column justify-content-start align-items-baseline pt-5">
                                <span style="font-size: 25px;" class="card-title pb-3 text-107980">
                                    {{$order_count['delivery']}}
                                </span>
                                <h4 style="font-size: 16px; color:#6D6D6D;"
                                    class="card-subtitle d-flex justify-content-between m-0 pb-1 align-items-center">
                                    <span>{{ translate('home delivery') }}</span>
                                </h4>
                                @if($percentageChanges['delivery'] > 0)
                                <span class="badge-soft-success px-2 py-1 rounded fs-2">
                                    <i class="tio-arrow-upward"></i>{{ translate($percentageChanges['delivery'] . '%') }}
                                </span>
                                @elseif($percentageChanges['delivery'] < 0)
                                <span class="badge-soft-danger px-2 py-1 rounded fs-2">
                                    <i class="tio-arrow-downward"></i>{{ translate($percentageChanges['delivery'] . '%') }}
                                </span>
                                @else
                                <span class="badge-soft-secondary px-2 py-1 rounded fs-2">
                                    <i class="tio-arrow-rightward"></i>{{ translate($percentageChanges['delivery'] . '%') }}
                                ...
                                <ul class="option-select-btn">
                                    <li>
                                        <label>
                                            ...
                                            <span data-order-type="dineOrder"
                                    ...
                                    <li>
                                        <label>
                                            <input type="radio" name="statistics" hidden="">
                                            <span data-order-type="takeawayOrder"
                                    ...
                                    <li>
                                        <label>
                                            <input type="radio" name="statistics" hidden="">
                                            <span data-order-type="delieveryOrder"
