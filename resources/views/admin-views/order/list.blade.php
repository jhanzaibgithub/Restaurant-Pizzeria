...
@section('content')
    ...
    @if($status == 'all')
                <div class="row g-2 mb-3">
                        ...
                        <a class="order--card h-100" href="javascript:void(0)">
                            <div class="d-flex flex-column justify-content-start align-items-baseline pt-5">
                                <span style="font-size: 25px;" class="card-title pb-3 text-107980">
                                    {{\App\CentralLogics\Helpers::currency_symbol()}} {{round($analytics['total_earning'],2)}}
                                </span>
                                <h4 style="font-size: 16px; color:#6D6D6D;"
                                    class="card-subtitle d-flex justify-content-between m-0 pb-1 align-items-center">
                                    <span>{{ translate('order_earning') }}</span>
                                </h4>

                                @if($analytics['earning_trend'] == 'up')
                                <span class="badge-soft-success px-2 py-1 rounded fs-2"><i
                                    class="tio-arrow-upward"></i>{{round($analytics['earning_change'],2)}}%
                                </span>
                                @else
                                <span class="badge-soft-danger px-2 py-1 rounded fs-2"><i
                                    class="tio-arrow-downward"></i>{{round($analytics['earning_change'],2)}}%
                                </span>
                                @endif
                            </div>
                        </a>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <a class="order--card h-100" href="{{ route('admin.orders.list', ['dine']) }}">
                            <div class="d-flex flex-column justify-content-start align-items-baseline pt-5">
                                <span style="font-size: 25px;" class="card-title pb-3 text-107980">
                                    {{$analytics['total_dine_in']}}
                                </span>
                                <h4 style="font-size: 16px; color:#6D6D6D;"
                                    class="card-subtitle d-flex justify-content-between m-0 pb-1 align-items-center">
                                    <span>{{ translate('Dine In') }}</span>
                                </h4>
                                @if($analytics['dine_in_trend'] == 'up')
                                <span class="badge-soft-success px-2 py-1 rounded fs-2"><i
                                    class="tio-arrow-upward"></i>{{round($analytics['dine_in_change'],2)}}%
                                </span>
                                @else
                                <span class="badge-soft-danger px-2 py-1 rounded fs-2"><i
                                    class="tio-arrow-downward"></i>{{round($analytics['dine_in_change'],2)}}%
                                </span>
                                @endif
                            </div>
                        </a>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <a class="order--card h-100" href="{{ route('admin.orders.list', ['takeaway']) }}">
                            <div class="d-flex flex-column justify-content-start align-items-baseline pt-5">
                                <span style="font-size: 25px;" class="card-title pb-3 text-107980">
                                    {{$analytics['total_take_away']}}
                                </span>
                                <h4 style="font-size: 16px; color:#6D6D6D;"
                                    class="card-subtitle d-flex justify-content-between m-0 pb-1 align-items-center">
                                    <span>{{ translate('Take Away') }}</span>
                                </h4>
                                @if($analytics['take_away_trend'] == 'up')
                                <span class="badge-soft-success px-2 py-1 rounded fs-2"><i
                                    class="tio-arrow-upward"></i>{{round($analytics['take_away_change'],2)}}%
                                </span>
                                @else
                                <span class="badge-soft-danger px-2 py-1 rounded fs-2"><i
                                    class="tio-arrow-downward"></i>{{round($analytics['take_away_change'],2)}}%
                                </span>
                                @endif
                            </div>
                        </a>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <a class="order--card h-100" href="{{ route('admin.orders.list', ['delivery']) }}">
                            <div class="d-flex flex-column justify-content-start align-items-baseline pt-5">
                                <span style="font-size: 25px;" class="card-title pb-3 text-107980">
                                    {{$analytics['total_home_delivery']}}
                                </span>
                                <h4 style="font-size: 16px; color:#6D6D6D;"
                                    class="card-subtitle d-flex justify-content-between m-0 pb-1 align-items-center">
                                    <span>{{ translate('Home Delivery') }}</span>
                                </h4>
                                @if($analytics['home_delivery_trend'] == 'up')
                                <span class="badge-soft-success px-2 py-1 rounded fs-2"><i
                                    class="tio-arrow-upward"></i>{{round($analytics['home_delivery_change'],2)}}%
                                </span>
                                @else
                                <span class="badge-soft-danger px-2 py-1 rounded fs-2"><i
                                    class="tio-arrow-downward"></i>{{round($analytics['home_delivery_change'],2)}}%
                                </span>
                                @endif
                            </div>
                        </a>
                ...
                <div class="row g-2 mb-3">
                    <div class="col-sm-6 col-lg-2">
                        <a class="order--card h-100" href="javascript:void(0);">
                            <div class="d-flex flex-column justify-content-start align-items-baseline pt-5">
                                <span style="font-size: 25px;" class="card-title pb-3 text-107980">
                                    {{\App\CentralLogics\Helpers::currency_symbol()}} {{round($analytics['single_earning'])}}
                                </span>
                                <h4 style="font-size: 16px; color:#6D6D6D;"
                                    class="card-subtitle d-flex justify-content-between m-0 pb-1 align-items-center">
                    ...
                    <div class="col-sm-6 col-lg-2">
                        <a class="order--card h-100" href="javascript:void(0);">
                            <div class="d-flex flex-column justify-content-start align-items-baseline pt-5">
                                ...
                                @if($analytics['completed_trend'] == 'up')
                                <span class="badge-soft-success px-2 py-1 rounded fs-2"><i
                                    class="tio-arrow-upward"></i>{{round($analytics['completed_change'],2)}}%
                                </span>
                                @else
                                <span class="badge-soft-danger px-2 py-1 rounded fs-2"><i
                                    class="tio-arrow-downward"></i>{{round($analytics['completed_change'],2)}}%
                                </span>
                                @endif
                            </div>
                        </a>
                                ...
                                <ul class="option-select-btn">
                                    <li>
                                        <label>
                                            ...
                                            <span data-order-type="dineOrders"
                                    ...
                                    <li>
                                        <label>
                                            <input type="radio" name="statistics" hidden="">
                                            <span data-order-type="takeawayOrders"
                                    ...
                                    <li>
                                        <label>
                                            <input type="radio" name="statistics" hidden="">
                                            <span data-order-type="deliveryOrder"
                                ...
                                <ul class="option-select-btn">
                                    <li>
                                        <label>
                                            ...
                                            <span data-order-type="{{ $status }}" data-delivery-type="delivered"
                                    ...
                                    <li>
                                        <label>
                                            <input type="radio" name="statistics" hidden="">
                                            <span data-order-type="{{ $status }}" data-delivery-type="processing"
                                    ...
                                    <li>
                                        <label>
                                            <input type="radio" name="statistics" hidden="">
                                            <span data-order-type="{{ $status }}" data-delivery-type="pending"
    ...
    <div class="card">
        <div class="card-header">
                ...
                <div class="table-responsive col-7 d-flex justify-content-end">
                        {!!$orders->links()!!}
                </div>
        </div>
                    ...
                    <tbody id="set-rows">
                        @foreach ($orders as $key => $order)
                            <tr class="status-{{ $order['order_status'] }} class-all">
                                ...
                                <td>
                                    <div>
                                        <!-- {{ \App\CentralLogics\Helpers::set_symbol($order['order_amount'] - $order['coupon_discount_amount'] - $order['extra_discount'] ) }} -->
                                ...
                                <td class="text-capitalize">
                                    <div class="d-flex justify-content-center gap-2">
                                        <a class="badge-soft-secondary px-2 py-1 rounded"
                                            ...
                                            {{ translate('View') }}</a>
                                            <a href="{{route('admin.orders.generate-invoice',[$order['id']])}}" class="badge-soft-secondary px-2 py-1 rounded" >
                                            PDF
                                            </a>
                                    </div>
                                </td>
...
@push('script_2')
    ...
    <script>
        function orderStatisticsUpdate(t) {
            ...
            let deliveryType = $(t).attr('data-delivery-type');
