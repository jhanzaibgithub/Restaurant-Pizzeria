        ...
        <div class="row justify-content-center" id="printableArea">
            ...
            <div class="col-5" id="printableAreaContent">
                <div class="text-center pt-4 mb-3">
                    <h2 style="line-height: 1">{{$businessSettings['restaurant_name'] ?? ''}}</h2>
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-12">
                        @if(isset($order->customer))
                            ...
                            @php($address=$order->delivery_address)
                            <h5>
                ...
                <div class="row justify-content-md-end mb-3" style="width: 99%">
                    <div class="col-md-7 col-lg-7">
                        <dl class="row text-right" style="color: black!important;">
                            ...
                            <dd class="col-6">{{ \App\CentralLogics\Helpers::set_symbol($order->total_tax_amount) }}</dd>
                            ...
                            <dd class="col-6">
                                {{ \App\CentralLogics\Helpers::set_symbol($sub_total+$total_tax+$add_ons_cost+$add_ons_tax_cost + $order->total_tax_amount) }}</dd>
                            ...
                            <dd class="col-6" style="font-size: 20px">{{ \App\CentralLogics\Helpers::set_symbol($sub_total+$del_c+$total_tax+$add_ons_cost-$order['coupon_discount_amount']-$order['extra_discount']+$add_ons_tax_cost + $order->total_tax_amount) }}</dd>
                        </dl>
                    </div>
                </div>
                <hr class="text-dark hr-style-2">
                ...
                <hr class="text-dark hr-style-2">
                <div class="text-center">{{$businessSettings['footer_text'] ?? ''}}</div>
            </div>
        </div>
    </div>
