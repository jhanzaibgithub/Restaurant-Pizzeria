        ...
        <div class="row g-3">
            <div class="col-12">
                <div class="card card-body">
                    <h3>{{translate('Category_Bulk_Import :')}} </h3>
                    ...
                    <ol class="order-list">
                        ...
                        <li>{{\App\CentralLogics\translate("After uploading categories you need to edit them and set product's images and choices.")}}</li>
                    ...
                    <form class="product-form" action="{{route('admin.category.bulk-import')}}" method="POST"
                        ...
                        <div class="rest-part">
                            <div class="d-flex flex-wrap justify-content-center gap-3">
                                ...
                                <a href="{{asset('assets/category_bulk_format.xlsx')}}" download=""
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-auto">
                                            <div class="upload-file">
                                                <input type="file" id="import-file" name="category_file" accept=".xlsx, .xls" class="upload-file__input">
