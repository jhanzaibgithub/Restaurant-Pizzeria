...
<style>
 ...
 <div class="inline-page-menu d-flex flex-row justify-content-between align-items-center">
     ...
     <ul class="list-unstyled">
         ...
         <li class="{{ Request::is('admin/category/bulk-import') || Request::is('admin/category/bulk-export')||Request::is('admin/product/bulk-import')||Request::is('admin/product/bulk-export') ? 'active' : '' }}">
