                            ...
                            @if(isset($config))
                                <div class="form-group">
                                    ...
                                    <select name="environment" class="form-control js-select2-custom">
                                        <option value="local" {{ $config['environment']=='local' ? 'selected' : ''}} >{{translate('local')}}</option>
                                        <option value="live" {{ $config['environment']=='live' ? 'selected' : ''}} >{{translate('live')}}</option>
                                    </select>
                                </div>
                                <div class="form-group">
