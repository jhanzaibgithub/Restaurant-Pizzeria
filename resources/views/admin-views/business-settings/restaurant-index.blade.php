    ...
    <div class="content container-fluid">
       <div  class="row li_hr-sub border mb-5 px-2 py-3 mx-1">
        ...
        <div class="row g-2">
            ...
            <div style="padding-left:44px; padding-right:44px;" class="col-12">
                <div class="card">
                    <div class="card-body" >
                        <div class="d-flex justify-content-between align-items-center border rounded mb-2 px-3 py-2">
                            @php($config = $settings['maintenance_mode'] ?? null)
                            <h5 class="mb-0 c1">
            ...
            <div class="col-12">
                ...
                enctype="multipart/form-data">
                    ...
                    <div class="card-footer">
                            ...
                            <div class="row">
                                @php($restaurant_name = $settings['restaurant_name'] ?? '')
                                ...
                                @php($email = $settings['email_address:'] ?? '')
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group">
                                ...
                                @php($time_format = $settings['time_format'] ?? '24')
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <div class="form-group">
                                ...
                                @php($currency_code = $settings['currency'] ?? 'USD')
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="">
                                            @php($config = $settings['currency_symbol_position'] ?? null)
                                ...
                                @php($decimal_point_settings = $settings['decimal_point_settings'] ?? null)
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <div class="form-group">
                                ...
                                @php($footer_text = $settings['footer_text'] ?? '')
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <div class="form-group">
                                        <label class="input-label">{{translate('Company_Coptyright_Text:')}}</label>
                                        <input type="text" value="{{$footer_text}}"
                                            name="footer_text" class="form-control" placeholder="{{translate('Ex: Copyright@restaurant-pizzeria.com')}}"
                                            required>
                                    </div>
                                </div>
                                @php($pagination_limit = $settings['pagination_limit'] ?? 10)
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <div class="form-group">
                                ...
                                @php($mov = $settings['minimum_order_value'] ?? 0)
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <div class="form-group">
                                ...
                                @php($default_preparation_time = $settings['default_preparation_time'] ?? null)
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    @php($schedule_order_slot_duration = $settings['schedule_order_slot_duration'] ?? null)
                                    <div class="form-group">
                                ...
                                @php($overall_tax = $settings['overall_tax'] ?? null)
                                    <div class="form-group">
                                        <label class="input-label text-capitalize">{{translate('overall_tax ')}}</label>
                                        <input type="number" value="{{$overall_tax}}"
                                            name="overall_tax" class="form-control" placeholder="{{translate('Ex: 2')}}"
                                            required>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    @php($order_confirmation_pic = $settings['order_confirmation_picture'] ?? null)
                                        <label class="input-label text-capitalize">{{translate('order_confirmation_picture')}}</label>
                                    <div class="form-control d-flex justify-content-between align-items-center gap-3">
                                        <div>
                                            <label class="text-dark mb-0">{{translate('order_confirmation')}}</label>
                                            <small class="text-danger">*</small>
                                        </div>
                                        <label class="switcher">
                                            <input class="switcher_input" type="checkbox" name="order_confirmation_picture" {{$order_confirmation_pic == null || $order_confirmation_pic == 0? '' : 'checked'}} id="order_confirmation_picture">
                                            <span class="switcher_control"></span>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                @php($value = $settings['point_per_currency'] ?? 0)
                                <div class="col-xl-4 col-md-6 col-sm-6 mt-4">
                                    @php($sp = $settings['self_pickup'] ?? null)
                                    <div class="form-control d-flex justify-content-between align-items-center gap-3">
                                        <div>
                                ...
                                <div class="col-xl-4 col-md-6 col-sm-6 mt-4">
                                    @php($del = $settings['delivery'] ?? null)
                                    <div class="form-control d-flex justify-content-between align-items-center gap-3">
                                        <div>
                                ...
                                <div class="col-xl-4 col-md-6 col-sm-6 mt-4">
                                    @php($ev = $settings['email_verification'] ?? 0)
                                    <div class="form-control d-flex justify-content-between align-items-center gap-3">
                                        <div>
                                ...
                                <div class="col-xl-4 col-md-6 col-sm-6 mt-4">
                                    @php($pv = $settings['phone_verification'] ?? null)
                                    <div class="form-control d-flex justify-content-between align-items-center gap-3">
                                        <div>
                                ...
                                <div class="col-xl-4 col-md-6 col-sm-6 mt-4">
                                    @php($dm_status = $settings['dm_self_registration'] ?? null)
                                    <div class="form-control d-flex justify-content-between align-items-center gap-3">
                                        <div>
                                            <label class="text-dark mb-0">{{translate('Deliveryman_Self_Registration')}}
                                            </label>
                                ...
                                <div class="col-xl-4 col-md-6 col-sm-6 mt-4">
                                    @php($vnv_status = $settings['toggle_veg_non_veg'] ?? null)
                                    <div class="form-control d-flex justify-content-between align-items-center gap-3">
                                        <div>
                                ...
                                <div class="col-xl-4 col-md-6 col-sm-6 mt-4">
                                    @php($sp = $settings['staus'] ?? null)
                                    <div class="form-control d-flex justify-content-between align-items-center gap-3">
                                        <div>
                                            <label class="text-dark mb-0">{{translate('Status')}}</label>

                                        </div>
                                        <label class="switcher">
                                            <input class="switcher_input" type="checkbox" name="status" {{$sp == null || $sp == 0? '' : 'checked'}} id="status">
                                            <span class="switcher_control"></span>
                                        </label>
                                    </div>
                                </div>
                    ...
                    <div class="card mt-3">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        @php($fav_icon = $settings['fav_icon'] ?? '')
                                        <div class="form-group mt-3">
                                    ...
                                    <div class="col-md-12 btn--container mt-4">
...
@push('script_2')
    ...
    <script>
        @php($time_zone = $settings['time_zone'] ?? null)
        $('[name=time_zone]').val("{{$time_zone}}");

        @php($language = $settings['language'] ?? '[]')
    ...
    <script>
        ...
        $(document).on('ready', function () {
            @php($country = $settings['country'] ?? 'BD')
