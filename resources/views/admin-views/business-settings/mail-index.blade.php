                        ...
                        <div class="card">
                            <div class="card-footer">
                                ...
                                <div class="row g-2">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-6 mb-3">
                                        <label class="input-label">{{translate('port:')}}</label>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-6 mb-3">
                                        <label class="input-label">{{translate('email')}} {{translate('id:')}}</label>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-6 mb-3">
                                        <label class="input-label">{{translate('encryption:')}}</label>
