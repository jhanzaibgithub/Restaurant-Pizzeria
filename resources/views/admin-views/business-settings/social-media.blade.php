    ...
    <div class="card mb-3">
            <div class="card-body">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        <h4 >
                            {{ translate('Social_Media_Settings') }}
                        </h4>
                    </div>
        ...
        <div class="card mb-3">
            <div class="card-header">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        <h5 >
                            {{ translate('Link_New_Social_Media') }}
                        </h5>
                    </div>
                </div>
            </div>
                ...
                success: function (data) {
                    ...
                    if (data.length != 0) {
                        ...
                        for (var count = 0; count < data.length; count++) {
                            ...
                            html += '<strong><td class="column_name text-order_id" data-column_name="name" data-id="' + data[count].id + '">' + data[count].name + '</td></strong>';
                            ...
                            html += '<td class="d-flex flex-row gap-2"><a type="button" class="btn btn-secondary btn-xs square-btn edit" id="' + data[count].id + '"> <i style="color:#A1A5B7;" class="tio-edit"></i> </a> <a type="button" class="btn btn-secondary btn-sm delete square-btn" id="' + data[count].id + '"> <i style="color:#A1A5B7;" class="tio-delete"></i> </a></td></tr>';
                        }
                        $('tbody').html(html);
                    }
                }
