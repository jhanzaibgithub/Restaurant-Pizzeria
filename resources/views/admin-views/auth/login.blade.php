...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="{{ $restaurantLogo ? asset('storage/restaurant/'.$restaurantLogo) : asset('assets/admin/img/logo.png') }}">
        ...
        <div class="row mx-5 my-1 p-2">
            <div class="col-md-6 col-sm-6 p-0 m-0 auth-left">
                <div class="card h-100">
                    <div style="border-top-left-radius: 10px; border-top-right-radius: 0px;" class="gold-background">
                        ...
                        <h1 class="text-white"> User Friendly Admin Panel.</h1>
                    </div>
            ...
            <div class="col-md-6 col-sm-6 p-0 m-0 auth-right">
                <div style="border-top-left-radius: 0px; border-bottom-left-radius: 0px;" class="card h-100">
                    <div class="card-body">
                        <form id="form-id" class="form" action="{{ route('admin.auth.login') }}" method="post">
                            @csrf
                            ...
                            <div class="js-form-message form-group">
                                <label class="input-label text-capitalize text-muted"
                                    for="signinSrEmail">{{ translate('email') }}
                            ...
                            <div class="demo-credentials">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div>
                                        <div class="demo-credentials__title">Demo Admin Credentials</div>
