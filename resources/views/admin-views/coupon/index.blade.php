                ...
                <form action="{{route('admin.coupon.store')}}" method="post">
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                           <h4> {{translate('Add_New_Coupon')}}</h4>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-footer">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-2 d-flex justify-content-end align-items-end">
                                    <div class="form-group">
                    ...
                    <div class="card-top px-card pt-4">
                        <div class="row justify-content-between align-items-center gy-2">
                            <div class="col-sm-4 col-md-6 col-lg-8">
                                ...
                                <span class="text-muted">{{ $coupons->total() }} coupons</span>
                            </div>
                            <div class="col-sm-8 col-md-6 col-lg-4">
                                <form action="{{ url()->current() }}" method="GET">
                                    <div class="input-group">
                                        <input id="datatableSearch_" type="search" name="search" class="form-control"
                                            placeholder="{{ translate('Search by ID, Coupon') }}"
                            ...
                            <table class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table">
                                ...
                                @foreach($coupons as $key=>$coupon)
                                    <tr>
                                        ...
                                        <td>
                                            <div>
                                                <div class="text-order_id fz-14"><strong>{{translate('code')}}: {{$coupon['code']}}</strong></div>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center gap-2">
                                                <a class="btn btn-secondary btn-sm edit square-btn openBtn" id="{{$coupon['id']}}" onclick="modalShow(this)">
                                                    <i style="color:#A1A5B7;" class="tio-invisible"></i>
                                                </a>

                                                <a class="btn btn-secondary btn-sm edit square-btn"
                                                href="{{route('admin.coupon.update',[$coupon['id']])}}"><i style="color:#A1A5B7;" class="tio-edit"></i></a>
                                                <button type="button" class="btn btn-secondary btn-sm delete square-btn"
                                                onclick="form_alert('coupon-{{$coupon['id']}}','{{translate('Want to delete this coupon ?')}}')"><i style="color:#A1A5B7;" class="tio-delete"></i></button>
                                            </div>
