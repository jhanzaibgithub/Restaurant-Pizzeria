...
<style>
    ...
    <div class="inline-page-menu">
        ...
        <ul class="list-unstyled">
            <li class="{{ Request::is('admin/table/list') ? 'active' : '' }}">
                <a class="menu-link" href="{{ route('admin.table.list') }}">{{ translate('Table_List') }}</a>
            </li>
            <li class="{{ Request::is('admin/table/index') ? 'active' : ''}}">
                <a class="menu-link" href="{{ route('admin.table.index') }}">{{ translate('Avalibility') }}</a>
            </li>
            <li class="{{ Request::is('admin/promotion/create') || Request::is('admin/promotion/edit*') ? 'active' : '' }}">
                <a class="menu-link" href="{{ route('admin.promotion.create') }}">{{ translate('Add New') }}</a>
            </li>
