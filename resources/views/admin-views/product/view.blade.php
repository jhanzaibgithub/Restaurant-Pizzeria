                    ...
                    <div class="col-md-5 d-flex justify-content-center">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="d-block">
                                ...
                                <p> {{translate('of')}} {{$product->reviews_count ?? 0}} {{translate('reviews')}}
                    ...
                    <div class="col-md-7">
                        ...
                        @endphp
                            <li class="d-flex align-items-center font-size-sm">
                                @php
                                $five=\App\CentralLogics\Helpers::rating_count($product['id'],5);
                                @endphp
                                <span
                            ...
                            <li class="d-flex align-items-center font-size-sm">
                                @php
                                $four=\App\CentralLogics\Helpers::rating_count($product['id'],4);
                                @endphp
                            ...
                            <li class="d-flex align-items-center font-size-sm">
                                @php
                                    $three=\App\CentralLogics\Helpers::rating_count($product['id'],3);
                                @endphp
                            ...
                            <li class="d-flex align-items-center font-size-sm">
                                @php
                                $two=\App\CentralLogics\Helpers::rating_count($product['id'],2);
                                @endphp
                            ...
                            <li class="d-flex align-items-center font-size-sm">
                                @php
                                $one=\App\CentralLogics\Helpers::rating_count($product['id'],1);
                                @endphp
        ...
        <div class="card mb-3 mb-lg-5">
            <div class="">
                <div class="table-responsive">
                    <table class="table table-bordered table-thead-bordered table-nowrap card-table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if (!empty($tags))
                                        @foreach ($tags as $tag)
                                            <span class="badge-soft-success mb-1 mr-1 d-inline-block px-2 py-1 rounded">
                                                {{ $tag }}
                                            </span>
                                        @endforeach
                                    @endif
