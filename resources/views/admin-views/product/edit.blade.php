                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="addon_ids[]" class="form-control" id="choose_addons" multiple="multiple">
                                                    @foreach($addons as $addon)
                                                        <option
                                                            value="{{$addon['id']}}" {{in_array($addon->id,[])?'selected':''}}>{{$addon['name']}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row g-2">
                                                <div class="col-12">
                                                    <div class="">
                                                        ...
                                                        <input type="text" class="form-control" name="tags" placeholder="Enter tags" value="@if(isset($product->tags) && is_array($product->tags)) @foreach($product->tags as $c) {{$c->tag.','}} @endforeach @endif" data-role="tagsinput">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
