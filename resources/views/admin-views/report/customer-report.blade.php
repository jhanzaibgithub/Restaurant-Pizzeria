    ...
    <div class="content container-fluid">
        <div class="card mb-3">
                    <div class="card-header d-flex flex-column align-items-baseline">
                        <div>
                                <h2 >{{translate('customers_report_overview')}}</h2>
                        </div>
                        <div class="mb-1">
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-sm-4">
                                        <div class="">
                                           ...
                                           <select class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate custom-select min-w200" name="branch" onchange="" id="select_branch">
        ...
        <div class="row g-2 px-5 my-3">
            <div style="    padding: 5px 40px 5px 40px;" class="col-sm-4">
                ...
                <img class="resturant-icon mb-3" src="{{asset('assets/admin/img/dashboard/report_total_customer.png')}}" alt="dashboard">
                    <h4 class="title text-white m-0">{{translate('Total_Customers')}}</h4>
            ...
            <div style="    padding: 5px 40px 5px 40px;" class="col-sm-4">
                <div class="dashboard--card bg--3">
                    <img class="resturant-icon mb-3" src="{{asset('assets/admin/img/dashboard/report_satisfied_customer.png')}}" alt="dashboard">
                    <h4 class="title text-white m-0">{{translate('Satisfied_Customers')}}</h4>
                    <span class="subtitle text-white">
                        Rs:130.00
                    </span>
                </div>
            ...
            <div style="    padding: 5px 40px 5px 40px;" class="col-sm-4">
                <div class="dashboard--card bg--1">
                    <img class="resturant-icon mb-3" src="{{asset('assets/admin/img/dashboard/report_growth_customer.png')}}" alt="dashboard">
                    <h4 class="title text-white m-0">{{translate('Customer_Growth')}}</h4>
                    <span class="subtitle text-white">
                      30.5%
                    </span>
                </div>
        ...
        <div class="card mb-3">
            <div class="card-body d-flex justify-content-between flex-wrap gap-2">
                <h6 class="d-flex align-items-center gap-2 mb-0">
                    <span class="h4 mb-0"> Customers Static</span>
                </h6>
